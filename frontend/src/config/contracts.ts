export const contracts = {
  ForgeToken: {
    address: process.env.NEXT_PUBLIC_FORGE_TOKEN_ADDRESS as `0x${string}`,
    abi: [
      {
        "inputs": [],
        "name": "name",
  ...
  IPNFT: {
    address: process.env.NEXT_PUBLIC_IP_NFT_ADDRESS as `0x${string}`,
    abi: [
      {
  ...
  IdeaForgeCore: {
    address: process.env.NEXT_PUBLIC_IDEA_FORGE_CORE_ADDRESS as `0x${string}`,
    abi: [
      {
        "inputs": [
  ...
  IdeaForgeDAO: {
    ...
    abi: [
      ...
      },
      {
        ...
        "outputs": [
          {
            "internalType": "struct IdeaForgeDAO.ProposalMetadata",
            "name": "",
            "type": "tuple",
            "components": [
              {"internalType": "enum IdeaForgeDAO.ProposalType", "name": "proposalType", "type": "uint8"},
  ...
  RevenueSplitter: {
    address: process.env.NEXT_PUBLIC_REVENUE_SPLITTER_ADDRESS as `0x${string}`,
    abi: [
      {
        "inputs": [{"internalType": "address", "name": "creator", "type": "address"}],
